...
exports.MemoryTrait = exports.HazardTrait = exports.TerminalTrait = exports.ShipPropTrait = exports.StateKeys = exports.MAX_SCORE = exports.ScoreIds = exports.Msg = exports.config = void 0;
exports.getPropId = getPropId;
exports.getMemory = getMemory;
exports.defineAction = defineAction;
exports.standardBlocked = standardBlocked;
...
exports.config = {
    ...
    author: 'John Googol',
    version: '1.0.0',
    description: 'A sci-fi salvage horror text adventure on a derelict corporate freighter. You are a grey-market salvager who drifted into range of The Stillwater after running low on fuel.',
};
// ============================================================================
// MESSAGE IDS
// ============================================================================
...
class ShipPropTrait {
    constructor(propId) {
        this.type = ShipPropTrait.type;
        this.propId = propId;
    }
}
exports.ShipPropTrait = ShipPropTrait;
ShipPropTrait.type = 'story.shipProp';
function getPropId(entity) {
    return entity.get(ShipPropTrait.type)?.propId;
}
/**
 * Marks a terminal entity that SOMS can speak through.
 */
class TerminalTrait {
    constructor(terminalId, isActive = false) {
        this.type = TerminalTrait.type;
        this.terminalId = terminalId;
        this.isActive = isActive;
    }
}
exports.TerminalTrait = TerminalTrait;
TerminalTrait.type = 'story.terminal';
/**
 * Marks an entity as a hazardous area or object.
 */
class HazardTrait {
    constructor(hazardType, severity = 1) {
        this.type = HazardTrait.type;
        this.hazardType = hazardType;
        this.severity = severity;
    }
}
exports.HazardTrait = HazardTrait;
HazardTrait.type = 'story.hazard';
/**
 * First-interaction flavor text. Fires once per entity on specified trigger action.
 */
class MemoryTrait {
    constructor(trigger, messageId) {
        this.type = MemoryTrait.type;
        this.trigger = trigger;
        this.messageId = messageId;
        this.recalled = false;
    }
}
exports.MemoryTrait = MemoryTrait;
MemoryTrait.type = 'story.memory';
function getMemory(entity) {
    return entity.get(MemoryTrait.type);
}
// ============================================================================
// ACTION HELPERS
// ============================================================================
function defineAction(id, group, phases) {
    return {
        id,
        group,
...
function standardBlocked(ctx, result) {
    return [ctx.event('action.blocked', {
            messageId: result.error || exports.Msg.NOTHING_HAPPENS,
            params: result.params || {},
        })];
}
function gameMessage(ctx, messageId, params) {
