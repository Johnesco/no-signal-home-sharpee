...
exports.buildResponseIntent = buildResponseIntent;
exports.selectMoodVariant = selectMoodVariant;
exports.applyCognitiveColoring = applyCognitiveColoring;
// ---------------------------------------------------------------------------
 ...
 */
function buildResponseIntent(candidate, topic, npcTrait, context) {
 ...
 */
function selectMoodVariant(baseMessageId, mood) {
 ...
 */
function applyCognitiveColoring(intent, profile) {
