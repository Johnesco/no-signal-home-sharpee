...
exports.InfluenceTracker = void 0;
/**
...
class InfluenceTracker {
     ...
     */
    track(influenceName, influencerId, targetId, effect, options) {
        ...
        const existing = this.effects.findIndex(e => e.influenceName === influenceName &&
     ...
     */
    isUnderInfluence(targetId, influenceName) {
        return this.effects.some(e => e.targetId === targetId && e.influenceName === influenceName);
    }
    /**
     ...
     */
    expireOnDeparture(influencerId, roomEntityIds) {
        const expired = [];
        this.effects = this.effects.filter(e => {
            if (e.influencerId === influencerId &&
     ...
     * @returns Effects that were cleared
     */
    expireTurn(currentTurn, evaluatePredicate) {
        const expired = [];
        this.effects = this.effects.filter(e => {
...
exports.InfluenceTracker = InfluenceTracker;
//# sourceMappingURL=influence-duration.js.map