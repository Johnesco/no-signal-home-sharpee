 ...
 */
export declare function hasNarrativeSettings(provider: LanguageProvider): provider is IEngineAwareLanguageProvider & {
    setNarrativeSettings: NonNullable<IEngineAwareLanguageProvider['setNarrativeSettings']>;
};
//# sourceMappingURL=language-provider-interface.d.ts.map