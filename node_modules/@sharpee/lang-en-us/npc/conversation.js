...
exports.conversationLanguage = void 0;
exports.conversationLanguage = {
    messages: {
        // -----------------------------------------------------------------------
        // Response action framing
        // -----------------------------------------------------------------------
        'character.conversation.response.deflect': '{npcName} changes the subject.',
        'character.conversation.response.refuse': '{npcName} refuses to discuss that.',
        'character.conversation.response.confabulate': '{npcName} seems to be filling in the gaps from memory.',
        ...
        'character.conversation.cognitive.detached': '{npcName} responds flatly, as if reciting from a great distance.',
        // -----------------------------------------------------------------------
        ...
        'character.conversation.attention.blocks': '{npcName} steps in front of you. "We\'re not done here."',
