...
exports.DEFAULT_NARRATIVE_CONTEXT = exports.PRONOUNS = void 0;
exports.conjugateVerb = conjugateVerb;
exports.resolvePerspectivePlaceholders = resolvePerspectivePlaceholders;
/**
 ...
 */
exports.DEFAULT_NARRATIVE_CONTEXT = {
    perspective: '2nd',
};
/**
 ...
 */
function getSubjectPronoun(context) {
    switch (context.perspective) {
        ...
        case '2nd':
            return 'You';
        case '3rd':
            const pronouns = context.playerPronouns || exports.PRONOUNS.THEY_THEM;
 ...
 */
function getPossessiveAdjective(context) {
    switch (context.perspective) {
        case '1st':
            return 'my';
        case '2nd':
 ...
 */
function getPossessivePronoun(context) {
    switch (context.perspective) {
        case '1st':
            return 'mine';
        case '2nd':
 ...
 */
function getReflexivePronoun(context) {
    switch (context.perspective) {
        case '1st':
            return 'myself';
        case '2nd':
 ...
 */
function getToBeContraction(context) {
    switch (context.perspective) {
        case '1st':
            return "I'm";
        case '2nd':
 ...
 */
function conjugateVerb(verb, context) {
 ...
 */
function resolvePerspectivePlaceholders(message, context = exports.DEFAULT_NARRATIVE_CONTEXT) {
    // Subject pronoun
