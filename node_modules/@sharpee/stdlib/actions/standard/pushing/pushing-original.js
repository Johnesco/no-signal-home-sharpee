...
exports.pushingAction = {
    ...
    validate(context) {
        ...
        const pushableTraitData = target.get(world_model_1.TraitType.PUSHABLE);
        ...
        const pushableTrait = pushableTraitData;
        ...
        switch (pushableTrait.pushType) {
            case 'button':
                ...
                if (target.has(world_model_1.TraitType.SWITCHABLE)) {
                    const switchableData = target.get(world_model_1.TraitType.SWITCHABLE);
                    if (switchableData) {
                        const switchable = switchableData;
    ...
    execute(context) {
        ...
        const target = context.command.directObject?.entity;
        const direction = context.command.parsed.extras?.direction;
        if (!target || !target.has(world_model_1.TraitType.PUSHABLE)) {
            return [];
        }
...
//# sourceMappingURL=pushing-original.js.map