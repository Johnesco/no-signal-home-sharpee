...
export interface PushingErrorData {
    reason: 'no_target' | 'not_visible' | 'not_reachable' | 'too_heavy' | 'wearing_it' | 'pushing_does_nothing' | 'fixed_in_place' | 'wont_budge';
    target?: string;
    requiresStrength?: number;
}
/**
...
//# sourceMappingURL=pushing-events.d.ts.map