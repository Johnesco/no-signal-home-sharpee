...
export interface PullingErrorData {
    reason: 'no_target' | 'not_visible' | 'not_reachable' | 'not_pullable' | 'too_heavy' | 'wearing_it' | 'wont_budge' | 'lever_stuck' | 'fixed_in_place' | 'already_pulled' | 'max_pulls_reached';
    target?: string;
...
//# sourceMappingURL=pulling-events.d.ts.map