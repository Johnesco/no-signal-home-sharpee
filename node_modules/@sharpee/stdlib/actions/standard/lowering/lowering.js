...
exports.loweringAction = void 0;
const capability_dispatch_1 = require("../../capability-dispatch");
 ...
 * ```
 */
exports.loweringAction = (0, capability_dispatch_1.createCapabilityDispatchAction)({
    actionId: constants_1.IFActions.LOWERING,
    group: 'manipulation',
