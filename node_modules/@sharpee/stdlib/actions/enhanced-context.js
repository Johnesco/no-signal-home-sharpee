...
const enhanced_types_1 = require("./enhanced-types");
...
class InternalActionContext {
    ...
    isInScope(entity) {
        ...
        return this.scopeResolver.getScope(this.player, entity) >= types_1.ScopeLevel.AWARE;
    }
    getVisible() {
    ...
    requireCarriedOrImplicitTake(entity) {
        ...
        if (actualScope >= types_1.ScopeLevel.CARRIED) {
            return { ok: true };
        }
        // Case 2: Not reachable - can't take it, return scope error
        if (actualScope < types_1.ScopeLevel.REACHABLE) {
            const error = this.getScopeError(types_1.ScopeLevel.REACHABLE, actualScope, entity);
        ...
        const takeContext = new InternalActionContext(this.world, this.player, this.currentLocation, taking_1.takingAction, takeCommand, this.scopeResolver);
    ...
    createEventInternal(type, eventData) {
        ...
        if (type.startsWith('if.')) {
            const entities = this.getEventEntities();
            return (0, core_1.createEvent)(type, eventData, entities);
        }
...
//# sourceMappingURL=enhanced-context.js.map