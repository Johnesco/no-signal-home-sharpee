...
exports.LightSourceBehavior = void 0;
const behavior_1 = require("../../behaviors/behavior");
const trait_types_1 = require("../trait-types");
const switchableBehavior_1 = require("../switchable/switchableBehavior");
/**
 * Behavior for light source entities.
 *
 * Handles the logic for entities that can provide illumination.
 */
class LightSourceBehavior extends behavior_1.Behavior {
    static requiredTraits = [trait_types_1.TraitType.LIGHT_SOURCE];
    /**
     * Turn on the light source
     * @returns true if successfully lit, false if out of fuel
     */
    static light(source) {
        const trait = LightSourceBehavior.require(source, trait_types_1.TraitType.LIGHT_SOURCE);
    ...
    static isLit(source) {
        ...
        if (source.hasTrait(trait_types_1.TraitType.SWITCHABLE)) {
            return switchableBehavior_1.SwitchableBehavior.isOn(source);
        }
     ...
     */
    static getFuelRemaining(source) {
        const trait = LightSourceBehavior.require(source, trait_types_1.TraitType.LIGHT_SOURCE);
     ...
     */
    static consumeFuel(source, amount) {
        const trait = LightSourceBehavior.require(source, trait_types_1.TraitType.LIGHT_SOURCE);
        // No fuel tracking
     ...
     */
    static getFuelPercentage(source) {
        const trait = LightSourceBehavior.require(source, trait_types_1.TraitType.LIGHT_SOURCE);
...
exports.LightSourceBehavior = LightSourceBehavior;
//# sourceMappingURL=lightSourceBehavior.js.map