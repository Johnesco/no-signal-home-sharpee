...
exports.CharacterModelTrait = void 0;
const character_vocabulary_1 = require("./character-vocabulary");
// ---------------------------------------------------------------------------
 ...
 */
class CharacterModelTrait {
    static type = 'characterModel';
    type = 'characterModel';
    ...
    constructor(data = {}) {
        ...
        if (data.moodValence !== undefined && data.moodArousal !== undefined) {
            ...
            const axes = character_vocabulary_1.MOOD_AXES[data.mood];
            this.moodValence = axes.valence;
            this.moodArousal = axes.arousal;
        }
        else {
            // Default: calm
            this.moodValence = character_vocabulary_1.MOOD_AXES.calm.valence;
            this.moodArousal = character_vocabulary_1.MOOD_AXES.calm.arousal;
        }
        ...
        if (data.threatValue !== undefined) {
            ...
            this.threatValue = character_vocabulary_1.THREAT_VALUES[data.threat];
        }
        else {
            this.threatValue = character_vocabulary_1.THREAT_VALUES.safe;
        }
        // Cognitive profile
        this.cognitiveProfile = {
            ...character_vocabulary_1.STABLE_COGNITIVE_PROFILE,
     ...
     */
    setPersonality(...exprs) {
        for (const expr of exprs) {
            const [trait, value] = (0, character_vocabulary_1.parsePersonalityExpr)(expr);
     ...
     */
    setDisposition(entityId, word) {
        this.dispositions[entityId] = (0, character_vocabulary_1.dispositionToValue)(word);
    }
    /**
     ...
     */
    adjustDisposition(entityId, delta) {
     ...
     */
    getDispositionWord(entityId) {
        return (0, character_vocabulary_1.valueToDisposition)(this.getDispositionValue(entityId));
    }
    // =========================================================================
    // Mood
    // =========================================================================
     ...
     */
    setMood(word) {
        const axes = character_vocabulary_1.MOOD_AXES[word];
        this.moodValence = axes.valence;
        this.moodArousal = axes.arousal;
    }
    /**
     ...
     */
    adjustMood(valenceDelta, arousalDelta) {
     ...
     */
    getMood() {
        return (0, character_vocabulary_1.nearestMood)(this.moodValence, this.moodArousal);
    }
    // =========================================================================
    // Threat
    // =========================================================================
     ...
     */
    setThreat(level) {
        this.threatValue = character_vocabulary_1.THREAT_VALUES[level];
    }
    /**
     ...
     */
    getThreat() {
        return (0, character_vocabulary_1.valueToThreat)(this.threatValue);
    }
    // =========================================================================
    // Knowledge
    // =========================================================================
     ...
     */
    addFact(topic, source, confidence, turn) {
     ...
     */
    addBelief(topic, strength, resistance = 'none') {
     ...
     */
    updateGoalPriority(id, priority) {
     ...
     */
    enterLucidityState(state, windowTurns = -1) {
    ...
    registerPlatformPredicates() {
        ...
        this.registerPredicate('threatened', (t) => t.threatValue >= character_vocabulary_1.THREAT_VALUES.threatened);
        this.registerPredicate('cornered', (t) => t.threatValue >= character_vocabulary_1.THREAT_VALUES.cornered);
        // --- Personality ---
        ...
        for (const mood of ['calm', 'content', 'cheerful', 'nervous', 'anxious', 'panicked',
            'angry', 'furious', 'sad', 'grieving', 'suspicious', 'confused', 'resigned']) {
            this.registerPredicate(mood, (t) => t.getMood() === mood);
        }
        // --- Cognitive state ---
        this.registerPredicate('lucid', (t) => t.currentLucidityState === 'lucid' || t.currentLucidityState === 'stable');
        this.registerPredicate('hallucinating', (t) => t.cognitiveProfile.perception === 'augmented' && t.currentLucidityState !== 'lucid');
        this.registerPredicate('fragmented', (t) => t.cognitiveProfile.coherence === 'fragmented');
        this.registerPredicate('dissociative', (t) => t.cognitiveProfile.selfModel === 'fractured');
        this.registerPredicate('belief resistant', (t) => t.cognitiveProfile.beliefFormation === 'resistant');
    }
}
exports.CharacterModelTrait = CharacterModelTrait;
//# sourceMappingURL=characterModelTrait.js.map