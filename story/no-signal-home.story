...
create the Airlock
  ...
  after entering it while the pressure readout is idle
...
create the captain's desk
  a container, openable, lockable with the multi-tool
  aka desk, drawer
  scenery
...
or
  You cannot hold a thought with that noise in it. It is coming from the
  cockpit, aft of here.
or
