...
export function extendLanguage(language: LanguageProvider): void {
  ...
  add(Msg.REED_ELEVATOR, '"Elevator motor\'s shot. Replacement parts should be in storage — forward, then starboard. I can help you install them if you bring them here."');
  ...
  add(Msg.ALARM_BLOCKED_CARGO, 'The proximity alarm screams from the cockpit. Aft. Move.');
